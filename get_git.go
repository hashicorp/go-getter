...
// resolveCheckoutRef resolves ref to a commit hash using rev-parse, guarding
// against argument injection via refs that begin with "-". Candidates cover
// bare refs, remote-tracking branches, and tags.
